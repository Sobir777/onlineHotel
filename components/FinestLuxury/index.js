    ...
    return (
        <>
            ...
            <div className={cls.container}>
                <div>
                    <Image src={imgg}  alt="aaa" ></Image>
                </div>

                <div className={cls.logo}>
                    <h3 className={cls.logoTitle}>Finest Luxury Hotels <br></br> &#x26; Resort</h3>
                    <p className={cls.logoDescription}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    <div>
                        <div>
